...
//CODE HERE
const spendingDiscount = deals[0].title.replace( '15% Off!', '10% Off!')


console.log(spendingDiscount)
/*
...
//CODE HERE
const monthDiscount = deals[1].desc.replace( 'March', 'April!').trim()

console.log(monthDiscount)
